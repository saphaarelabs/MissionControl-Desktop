...
import { isDesktopApp, openExternal } from '../lib/desktop';
    ...
    const startConnection = async (toolkit) => {
        ...
        try {
            const payload = {
                ...
                callbackUrl: isDesktopApp() ? undefined : (() => {
            ...
            if (isDesktopApp()) {
                ...
                setStatus(`Continue ${toolkit.name} connection in your browser, then come back here and refresh.`);
                return;
            }
                    ...
                    <div className="flex items-start justify-between gap-4">
                        <div>
                            ...
                            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
                                These integrations are scoped to the signed-in Mission Control user and exposed to agents through Composio once connected.
                            </p>
                        </div>
                        <button
                            type="button"
        ...
        try {
            ...
            if (data.instructions && data.instructions.length > 0) {
                ...
                if (isDesktopApp) {
                    ...
                    setStatus('OAuth opened in your browser. Finish the provider flow there and return to the app.');
                } else {
            ...
            {providerKey === 'custom' && (
                <div className="rounded-[24px] border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
                    <div className="mb-3">
                        ...
                        <p className="text-xs text-slate-500 mb-3">
                            Define the provider identity, authentication, and model IDs exactly as they should be written into OpenClaw.
                        </p>
                    </div>
